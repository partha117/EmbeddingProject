...
if __name__ == "__main__":
    ...
    root_path = "/project/def-m2nagapp/partha9/Aster/Text_Extended_Roberta_MLM/"
    ...
    config = RobertaConfig.from_pretrained(
        "/project/def-m2nagapp/partha9/model_cache/roberta_1500_config/")  # RobertaConfig.from_pretrained("roberta-base",max_position_embeddings=3500)
    model = RobertaForMaskedLM(
        config=config)  # RobertaForMaskedLM.from_pretrained(root_path + "/train_output/" + "checkpoint-6500/") #RobertaForMaskedLM(config=config)
    trainer = Trainer(
        model=model,
        args=training_args,
