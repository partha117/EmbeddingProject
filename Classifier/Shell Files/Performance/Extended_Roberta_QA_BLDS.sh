...
--model_path /project/def-m2nagapp/partha9/Aster/Classifier_Text_Extended_Roberta_QA_BLDS/ \
--model_no 9 \
--scratch_path /scratch/partha9/ \
--tokenizer_path /project/def-m2nagapp/partha9/Aster/Text_Extended_Roberta_QA/ \
--token_max_size 1498 \
--batch_size 32 \
