...
class BugDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        before, after = self.tokenizer.encode_plus(temp[0], temp[1], truncation=True, max_length=2048)['input_ids'], \
                        self.tokenizer.encode_plus(temp[0], temp[2], truncation=True, max_length=2048)['input_ids']
...
if __name__ == "__main__":
    ...
    root_path = "/project/def-m2nagapp/partha9/Aster/Text_Reformer_QA/"
